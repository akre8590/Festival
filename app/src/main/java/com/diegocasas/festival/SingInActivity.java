...
public class SingInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final View activityRootView = findViewById(R.id.sing_in);
        ...
        ahlogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(email)) {
                    Toast.makeText(getApplicationContext(), "Por favor ingrese el email id", Toast.LENGTH_SHORT).show();
                    return;
                }
                        ...
                        .addOnCompleteListener(SingInActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(SingInActivity.this, getString(R.string.failed), Toast.LENGTH_LONG).show();
                                }
                            }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(SingInActivity.this, "Falló la autenticación", Toast.LENGTH_SHORT).show();
                            //updateUI(null);
                        }
